...
void sensor_print(char x[], char y[], char z[], int16_t ax, int16_t ay, int16_t az){
  Serial.print(x);
...
void sensor_differential_print(char x[], char y[], char z[], int16_t ax, int16_t ay, int16_t az, int16_t bx, int16_t by, int16_t bz){
  Serial.print(",");
  Serial.print(x);
  Serial.print(",");
